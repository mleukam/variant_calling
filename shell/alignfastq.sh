...
# align paried-end whole exome reads for variant calling
# start with fastq, end with merged, marked, aligned bam with recalibrated quality scores
# intended to run on gardner HPC with PBS wrapper
# before using, make executable with chmod

#### INPUTS
# 1. Fastq files from theragen
